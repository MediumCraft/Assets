...
//!! generated by clutz.
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka {
  class Player extends ?_?.clutz.shaka.util.FakeEventTarget implements ?_?.clutz.shaka.util.IDestroyable {
    ...
    constructor (mediaElement ? : HTMLMediaElement | null , videoContainer ? : HTMLElement | null , dependencyInjector ? : (a : ?_?.clutz.shaka.Player | null ) => any ) ;
    /**
     ...
     */
    addChaptersTrack (uri : string , language : string , mimeType ? : string ) : Promise < ?_?.clutz.shaka.extern.ChapterTrack > ;
    /**
     ...
     */
    addTextTrackAsync (uri : string , language : string , kind : string , mimeType ? : string , codec ? : string , label ? : string , forced ? : boolean ) : Promise < ?_?.clutz.shaka.extern.TextTrack > ;
    /**
     ...
     * application.
     */
    addThumbnailsTrack (uri : string , mimeType ? : string ) : Promise < ?_?.clutz.shaka.extern.ImageTrack > ;
    /**
     ...
     */
    detachAndSavePreload (keepAdManager ? : boolean , savePosition ? : boolean ) : Promise < ?_?.clutz.shaka.media.PreloadManager | null > ;
    /**
     ...
     */
    getActiveSessionsMetadata ( ) : ?_?.clutz.shaka.extern.DrmSessionMetadata [] ;
    /**
     ...
     */
    getAllThumbnails (trackId ? : number | null ) : Promise < ?_?.clutz.shaka.extern.Thumbnail [] | null > ;
    /**
     ...
     */
    getAudioTracks ( ) : ?_?.clutz.shaka.extern.AudioTrack [] ;
    /**
     ...
     */
    getChaptersAsync (language : string ) : Promise < ?_?.clutz.shaka.extern.Chapter [] > ;
    /**
     * Return a list of chapters tracks.
     */
    getChaptersTracks ( ) : ?_?.clutz.shaka.extern.ChapterTrack [] ;
    /**
     ...
     */
    getFetchedPlaybackInfo ( ) : ?_?.clutz.shaka.extern.PlaybackInfo ;
    /**
     * Return a list of image tracks that can be switched to.
     * If the player has not loaded content, this will return an empty list.
     */
    getImageTracks ( ) : ?_?.clutz.shaka.extern.ImageTrack [] ;
    /**
     ...
     * management.
     */
    getQueueManager ( ) : ?_?.clutz.shaka.extern.IQueueManager | null ;
    /**
     ...
     * If the player has not loaded content, this will return an empty list.
     */
    getTextTracks ( ) : ?_?.clutz.shaka.extern.TextTrack [] ;
    /**
     * Return a Thumbnail object from a time.
     * If the player has not loaded content, this will return a null.
     */
    getThumbnails (trackId : number | null , time : number ) : Promise < ?_?.clutz.shaka.extern.Thumbnail | null > ;
    /**
     ...
     */
    getVideoTracks ( ) : ?_?.clutz.shaka.extern.VideoTrack [] ;
    /**
     ...
     */
    load (assetUriOrPreloader : string | ?_?.clutz.shaka.media.PreloadManager | null , startTime ? : number | null | Date , mimeType ? : string | null ) : Promise < any > ;
    /**
     ...
     * @param startTime When <code>startTime</code> is <code>null</code> or <code>undefined</code>, playback will start at the default start time (0 for VOD and liveEdge for LIVE).
     */
    preload (assetUri : string , startTime ? : number | null | Date , mimeType ? : string | null , config ? : ?_?.clutz.shaka.extern.PlayerConfiguration | null ) : Promise < ?_?.clutz.shaka.media.PreloadManager | null > ;
    /**
     ...
     */
    selectAudioTrack (audioTrack : ?_?.clutz.shaka.extern.AudioTrack , safeMargin ? : number ) : any ;
    /**
     ...
     * selections.
     */
    selectTextTrack (track ? : ?_?.clutz.shaka.extern.TextTrack | null ) : any ;
    /**
     ...
     * @param safeMargin Optional amount of buffer (in seconds) to retain when clearing the buffer. Useful for switching quickly without causing a buffering event. Defaults to 0 if not provided. Can cause hiccups on some browsers if chosen too small, e.g. The amount of two segments is a fair minimum to consider as safeMargin value.
     */
    selectVideoTrack (videoTrack : ?_?.clutz.shaka.extern.VideoTrack , clearBuffer ? : boolean , safeMargin ? : number ) : any ;
    /**
     ...
     */
    unloadAndSavePreload (initializeMediaSource ? : boolean , keepAdManager ? : boolean , savePosition ? : boolean ) : Promise < ?_?.clutz.shaka.media.PreloadManager | null > ;
    /**
     ...
     * This method needs to be called before instantiating the Player class.
     */
    static setQueueManagerFactory (factory : ?_?.clutz.shaka.extern.IQueueManager.Factory ) : any ;
...
declare namespace ?_?.clutz.shaka.abr {
  class SimpleAbrManager implements ?_?.clutz.shaka.extern.AbrManager , ?_?.clutz.shaka.util.IReleasable {
    private noStructuralTyping_shaka_abr_SimpleAbrManager : any;
    chooseVariant (preferFastSwitching ? : boolean ) : ?_?.clutz.shaka.extern.Variant ;
    ...
    release ( ) : any ;
    segmentDownloaded (deltaTimeMs : number , numBytes : number , allowSwitch : boolean , request ? : ?_?.clutz.shaka.extern.Request , context ? : ?_?.clutz.shaka.extern.RequestContext ) : any ;
...
declare namespace ?_?.clutz.shaka.ads {
  abstract class AbstractAd implements ?_?.clutz.shaka.extern.IAd {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ads {
  class ClientSideAd extends ?_?.clutz.shaka.ads.AbstractAd {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ads {
  class InterstitialAd extends ?_?.clutz.shaka.ads.AbstractAd {
    private noStructuralTyping_shaka_ads_InterstitialAd : any;
    constructor (video : HTMLMediaElement | null , interstitial : ?_?.clutz.shaka.extern.AdInterstitial , onSkip : ( ) => any , sequenceLength : number , adPosition : number , isUsingAnotherMediaElement : boolean ) ;
  }
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ads {
  class InterstitialStaticAd extends ?_?.clutz.shaka.ads.AbstractAd {
    private noStructuralTyping_shaka_ads_InterstitialStaticAd : any;
    constructor (interstitial : ?_?.clutz.shaka.extern.AdInterstitial , sequenceLength : number , adPosition : number ) ;
  }
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ads {
  class MediaTailorAd extends ?_?.clutz.shaka.ads.AbstractAd {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ads {
  class ServerSideAd extends ?_?.clutz.shaka.ads.AbstractAd {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ads {
  class SvtaAd extends ?_?.clutz.shaka.ads.AbstractAd {
    private noStructuralTyping_shaka_ads_SvtaAd : any;
    constructor (video : HTMLMediaElement | null , info : ?_?.clutz.shaka.extern.AdTrackingInfo ) ;
  }
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ads {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.cea {
  /**
   * CEA-X08 captions decoder.
   */
  class CeaDecoder implements ?_?.clutz.shaka.extern.ICaptionDecoder {
    private noStructuralTyping_shaka_cea_CeaDecoder : any;
    clear ( ) : any ;
    decode ( ) : ?_?.clutz.shaka.extern.ICaptionDecoder.ClosedCaption [] ;
...
declare namespace ?_?.clutz.shaka.cea {
   ...
   */
  class Mp4CeaParser implements ?_?.clutz.shaka.extern.ICeaParser {
    private noStructuralTyping_shaka_cea_Mp4CeaParser : any;
    init (initSegment : ArrayBuffer | ArrayBufferView ) : any ;
    parse (mediaSegment : ArrayBuffer | ArrayBufferView ) : ?_?.clutz.shaka.extern.ICeaParser.CaptionPacket [] ;
  }
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.cea {
   ...
   * MPEG TS CEA parser.
   */
  class TsCeaParser implements ?_?.clutz.shaka.extern.ICeaParser {
...
declare namespace ?_?.clutz.shaka.dash {
  ...
  class DashParser implements ?_?.clutz.shaka.extern.ManifestParser {
    ...
    configure (config : ?_?.clutz.shaka.extern.ManifestConfiguration , isPreloadFn ? : ( ) => boolean ) : any ;
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.drm {
  class FairPlay {
    private noStructuralTyping_shaka_drm_FairPlay : any;
    /**
     * Common FairPlay response transform for some DRMs providers.
     */
    static commonFairPlayResponse (type : ?_?.clutz.shaka.net.NetworkingEngine.RequestType , response : ?_?.clutz.shaka.extern.Response , context ? : ?_?.clutz.shaka.extern.RequestContext ) : any ;
    /**
     * Conax FairPlay request.
     */
    static conaxFairPlayRequest (type : ?_?.clutz.shaka.net.NetworkingEngine.RequestType , request : ?_?.clutz.shaka.extern.Request , context ? : ?_?.clutz.shaka.extern.RequestContext ) : any ;
    /**
     * Conax initDataTransform configuration.
     */
    static conaxInitDataTransform (initData : Uint8Array , initDataType : string , drmInfo : ?_?.clutz.shaka.extern.DrmInfo | null ) : Uint8Array ;
    /**
     ...
     */
    static expressplayFairPlayRequest (type : ?_?.clutz.shaka.net.NetworkingEngine.RequestType , request : ?_?.clutz.shaka.extern.Request , context ? : ?_?.clutz.shaka.extern.RequestContext ) : any ;
    /**
     * ExpressPlay initDataTransform configuration.
     */
    static expressplayInitDataTransform (initData : Uint8Array , initDataType : string , drmInfo : ?_?.clutz.shaka.extern.DrmInfo | null ) : Uint8Array ;
    /**
     * EZDRM FairPlay request.
     */
    static ezdrmFairPlayRequest (type : ?_?.clutz.shaka.net.NetworkingEngine.RequestType , request : ?_?.clutz.shaka.extern.Request , context ? : ?_?.clutz.shaka.extern.RequestContext ) : any ;
    /**
     * EZDRM initDataTransform configuration.
     */
    static ezdrmInitDataTransform (initData : Uint8Array , initDataType : string , drmInfo : ?_?.clutz.shaka.extern.DrmInfo | null ) : Uint8Array ;
    /**
     ...
     */
    static muxFairPlayRequest (type : ?_?.clutz.shaka.net.NetworkingEngine.RequestType , request : ?_?.clutz.shaka.extern.Request , context ? : ?_?.clutz.shaka.extern.RequestContext ) : any ;
    /**
     * Mux initDataTransform configuration.
     */
    static muxInitDataTransform (initData : Uint8Array , initDataType : string , drmInfo : ?_?.clutz.shaka.extern.DrmInfo | null ) : Uint8Array ;
    /**
     * Verimatrix FairPlay request.
     */
    static verimatrixFairPlayRequest (type : ?_?.clutz.shaka.net.NetworkingEngine.RequestType , request : ?_?.clutz.shaka.extern.Request , context ? : ?_?.clutz.shaka.extern.RequestContext ) : any ;
    /**
     * Verimatrix initDataTransform configuration.
     */
    static verimatrixInitDataTransform (initData : Uint8Array , initDataType : string , drmInfo : ?_?.clutz.shaka.extern.DrmInfo | null ) : Uint8Array ;
  }
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
...
declare namespace ?_?.clutz.shaka.lcevc {
  class Dec implements ?_?.clutz.shaka.util.IReleasable {
    private noStructuralTyping_shaka_lcevc_Dec : any;
    constructor (media : HTMLVideoElement | null , canvas : HTMLCanvasElement | null , lcevcConfig : ?_?.clutz.shaka.extern.LcevcConfiguration , isDualTrack : boolean ) ;
    /**
     * Close LCEVC Decoder.
     */
    release ( ) : any ;
...
declare namespace ?_?.clutz.shaka.media {
  ...
  class AdaptationSet {
    ...
    constructor (root : ?_?.clutz.shaka.extern.Variant , candidates ? : Iterable < ?_?.clutz.shaka.extern.Variant > , compareCodecs ? : boolean ) ;
  }
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.media {
   ...
   */
  class ClosedCaptionParser implements ?_?.clutz.shaka.media.IClosedCaptionParser {
    ...
    static findDecoder ( ) : ( ?_?.clutz.shaka.extern.CaptionDecoderPlugin ) | null ;
    static findParser (mimeType : string ) : ( ?_?.clutz.shaka.extern.CeaParserPlugin ) | null ;
    static registerDecoder (plugin : ?_?.clutz.shaka.extern.CaptionDecoderPlugin ) : any ;
    static registerParser (mimeType : string , plugin : ?_?.clutz.shaka.extern.CeaParserPlugin ) : any ;
...
declare namespace ?_?.clutz.shaka.media {
  ...
  class InitSegmentReference {
    ...
    constructor (uris : ( ) => string [] , startByte : number , endByte : number | null , mediaQuality ? : null | ?_?.clutz.shaka.extern.MediaQualityInfo , timescale ? : null | number , segmentData ? : null | ArrayBuffer | ArrayBufferView , aesKey ? : ?_?.clutz.shaka.extern.aesKey | null , encrypted ? : boolean ) ;
    /**
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.media.ManifestParser {
...
declare namespace ?_?.clutz.shaka.media {
   ...
   */
  class MetaSegmentIndex extends ?_?.clutz.shaka.media.SegmentIndex implements ?_?.clutz.shaka.util.IReleasable , Iterable < ?_?.clutz.shaka.media.SegmentReference | null > {
    ...
    [Symbol.iterator]():  Iterator < ?_?.clutz.shaka.media.SegmentReference | null > ;
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.media {
  class PreloadManager extends ?_?.clutz.shaka.util.FakeEventTarget implements ?_?.clutz.shaka.util.IDestroyable {
     ...
     */
    getPrefetchedTextTrack ( ) : ?_?.clutz.shaka.extern.TextTrack | null ;
    /**
     * Gets the preloaded variant track if it exists.
     */
    getPrefetchedVariantTrack ( ) : ?_?.clutz.shaka.extern.Track | null ;
    /**
...
declare namespace ?_?.clutz.shaka.media {
  ...
  class PresentationTimeline {
     ...
     * information.
     */
    notifyTimeRange (timeline : ?_?.clutz.shaka.media.PresentationTimeline.TimeRange [] , startOffset : number ) : any ;
    /**
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.media.PresentationTimeline {
...
declare namespace ?_?.clutz.shaka.media {
   ...
   * SegmentIndex.
   */
  class SegmentIndex implements ?_?.clutz.shaka.extern.SegmentIndex , ?_?.clutz.shaka.util.IReleasable , Iterable < ?_?.clutz.shaka.media.SegmentReference | null > {
     ...
     */
    getIteratorForTime (time : number , allowNonIndependent ? : boolean , reverse ? : boolean ) : ?_?.clutz.shaka.media.SegmentIterator | null ;
    getNumEvicted ( ) : any ;
...
declare namespace ?_?.clutz.shaka.media {
  ...
  class SegmentIterator implements Iterator < ?_?.clutz.shaka.media.SegmentReference | null > {
     ...
     * An iterator over a SegmentIndex's references.
     */
    constructor (segmentIndex : ?_?.clutz.shaka.media.SegmentIndex , index : number , partialSegmentIndex : number , reverse : boolean ) ;
    current ( ) : ?_?.clutz.shaka.media.SegmentReference | null ;
    currentPosition ( ) : number ;
    next ( ) : IteratorResult < ?_?.clutz.shaka.media.SegmentReference | null > ;
...
declare namespace ?_?.clutz.shaka.media.SegmentPrefetch {
  type FetchDispatcher = (a : ?_?.clutz.shaka.media.InitSegmentReference | ?_?.clutz.shaka.media.SegmentReference , b : ?_?.clutz.shaka.extern.Stream , c ? : ( (a : ArrayBuffer | ArrayBufferView ) => Promise < any > ) | null ) => ?_?.clutz.shaka.net.NetworkingEngine.PendingRequest ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.media {
  /**
...
declare namespace ?_?.clutz.shaka.net {
  class HttpFetchPlugin {
    ...
    static parse (uri : string , request : ?_?.clutz.shaka.extern.Request , requestType : ?_?.clutz.shaka.net.NetworkingEngine.RequestType , progressUpdated : ?_?.clutz.shaka.extern.ProgressUpdated , headersReceived : ?_?.clutz.shaka.extern.HeadersReceived , config : ?_?.clutz.shaka.extern.SchemePluginConfig ) : ?_?.clutz.shaka.extern.IAbortableOperation < any > ;
  }
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.net {
...
declare namespace ?_?.clutz.shaka.net {
  ...
  class NetworkingEngine extends ?_?.clutz.shaka.util.FakeEventTarget implements ?_?.clutz.shaka.util.IDestroyable {
     ...
     * Each scheme has at most one plugin to handle the request.
     */
    constructor (onProgressUpdated ? : ?_?.clutz.shaka.net.NetworkingEngine.onProgressUpdated , onHeadersReceived ? : ?_?.clutz.shaka.net.NetworkingEngine.OnHeadersReceived , onDownloadCompleted ? : ?_?.clutz.shaka.net.NetworkingEngine.OnDownloadCompleted , onDownloadFailed ? : ?_?.clutz.shaka.net.NetworkingEngine.OnDownloadFailed , onRequest ? : ?_?.clutz.shaka.net.NetworkingEngine.OnRequest , onRetry ? : ?_?.clutz.shaka.net.NetworkingEngine.OnRetry , onResponse ? : ?_?.clutz.shaka.net.NetworkingEngine.OnResponse ) ;
    /**
    ...
    configure (config : ?_?.clutz.shaka.extern.NetworkingConfiguration ) : any ;
    destroy ( ) : Promise < any > ;
    /**
     ...
     */
    request (type : ?_?.clutz.shaka.net.NetworkingEngine.RequestType , request : ?_?.clutz.shaka.extern.Request , context ? : ?_?.clutz.shaka.extern.RequestContext ) : ?_?.clutz.shaka.net.NetworkingEngine.PendingRequest ;
    /**
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.net.NetworkingEngine {
  type OnDownloadCompleted = (a : ?_?.clutz.shaka.extern.Request , b : ?_?.clutz.shaka.extern.Response ) => any ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.net.NetworkingEngine {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.net.NetworkingEngine {
  type OnRequest = (a : ?_?.clutz.shaka.net.NetworkingEngine.RequestType , b : ?_?.clutz.shaka.extern.Request , c : ?_?.clutz.shaka.extern.RequestContext | undefined ) => any ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.net.NetworkingEngine {
  type OnResponse = (a : ?_?.clutz.shaka.net.NetworkingEngine.RequestType , b : ?_?.clutz.shaka.extern.Response , c : ?_?.clutz.shaka.extern.RequestContext | undefined ) => any ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.net.NetworkingEngine {
  type OnRetry = (a : ?_?.clutz.shaka.net.NetworkingEngine.RequestType , b : ?_?.clutz.shaka.extern.RequestContext | undefined , c : string , d : string ) => any ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.net.NetworkingEngine {
  /**
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.net.NetworkingEngine {
  type onProgressUpdated = (a : number , b : number , c : boolean , d ? : ?_?.clutz.shaka.extern.Request , e ? : ?_?.clutz.shaka.extern.RequestContext ) => any ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
...
declare namespace ?_?.clutz.shaka.offline {
  class Storage implements ?_?.clutz.shaka.util.IDestroyable {
     ...
     */
    store (uri : string , appMetadata ? : object , mimeType ? : string | null , externalThumbnails ? : string [] | null , externalText ? : ?_?.clutz.shaka.extern.ExtraText [] | null ) : ?_?.clutz.shaka.extern.IAbortableOperation < any > ;
    /**
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.offline.indexeddb {
  /**
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.queue {
  class QueueManager extends ?_?.clutz.shaka.util.FakeEventTarget implements ?_?.clutz.shaka.extern.IQueueManager , ?_?.clutz.shaka.util.IDestroyable {
...
declare namespace ?_?.clutz.shaka.text {
  class Cue {
     ...
     */
    nestedCues : ?_?.clutz.shaka.text.Cue [] ;
    /**
     ...
     */
    region : ?_?.clutz.shaka.text.CueRegion | null ;
    /**
     ...
     */
    static parseCuePayload (cue : ?_?.clutz.shaka.text.Cue , styles ? : Map < string , ?_?.clutz.shaka.text.Cue > ) : any ;
  }
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
...
declare namespace ?_?.clutz.shaka.text {
   ...
   */
  class NativeTextDisplayer implements ?_?.clutz.shaka.extern.TextDisplayer {
...
declare namespace ?_?.clutz.shaka.text {
   ...
   */
  class StubTextDisplayer implements ?_?.clutz.shaka.extern.TextDisplayer {
...
declare namespace ?_?.clutz.shaka.transmuxer {
  class AacTransmuxer implements ?_?.clutz.shaka.extern.Transmuxer {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.transmuxer {
  class Ac3Transmuxer implements ?_?.clutz.shaka.extern.Transmuxer {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.transmuxer {
  class Ec3Transmuxer implements ?_?.clutz.shaka.extern.Transmuxer {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.transmuxer {
  class Mp3Transmuxer implements ?_?.clutz.shaka.extern.Transmuxer {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.transmuxer {
  class MpegTsTransmuxer implements ?_?.clutz.shaka.extern.Transmuxer {
...
declare namespace ?_?.clutz.shaka.transmuxer {
  class TransmuxerEngine implements ?_?.clutz.shaka.util.IDestroyable {
    ...
    destroy ( ) : Promise < any > ;
    static findTransmuxer (mimeType : string , contentType ? : string ) : ( ?_?.clutz.shaka.extern.TransmuxerPlugin ) | null ;
    static registerTransmuxer (mimeType : string , plugin : ?_?.clutz.shaka.extern.TransmuxerPlugin , priority : number ) : any ;
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.transmuxer {
  class TsTransmuxer implements ?_?.clutz.shaka.extern.Transmuxer {
...
declare namespace ?_?.clutz.shaka.ui {
  class AdInfo extends ?_?.clutz.shaka.ui.Element {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ui {
  class AdStatisticsButton extends ?_?.clutz.shaka.ui.Element {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ui {
  class ChapterSelection extends ?_?.clutz.shaka.ui.SettingsMenu {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ui {
  class ContentTitle extends ?_?.clutz.shaka.ui.Element {
...
declare namespace ?_?.clutz.shaka.ui {
  ...
  class Controls extends ?_?.clutz.shaka.util.FakeEventTarget implements ?_?.clutz.shaka.util.IDestroyable {
     ...
     * A container for custom video controls.
     */
    constructor (player : ?_?.clutz.shaka.Player , videoContainer : HTMLElement , video : HTMLMediaElement , vrCanvas : HTMLCanvasElement | null , config : ?_?.clutz.shaka.extern.UIConfiguration ) ;
    /**
    ...
    getAdCuePoints ( ) : ?_?.clutz.shaka.extern.AdCuePoint [] ;
    getAdManager ( ) : ?_?.clutz.shaka.extern.IAdManager | null ;
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ui {
  class HiddenFastForwardButton extends ?_?.clutz.shaka.ui.HiddenSeekButton {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ui {
  class HiddenRewindButton extends ?_?.clutz.shaka.ui.HiddenSeekButton {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ui {
  class HiddenSeekButton extends ?_?.clutz.shaka.ui.Element {
...
declare namespace ?_?.clutz.shaka.ui {
  class Icon {
    ...
    constructor (parent : Element | null , icon ? : ?_?.clutz.shaka.extern.UIIcon | string | null ) ;
    getDataUrl ( ) : string ;
    getSvgElement ( ) : any ;
    /**
     * If a single string is passed, it is treated as an SVG path
     */
    use (icon : ?_?.clutz.shaka.extern.UIIcon | string ) : any ;
  }
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ui {
  class IconRegistry {
     ...
     * If a single string is passed, it is treated as an SVG path
     */
    static register (name : string , icon : ?_?.clutz.shaka.extern.UIIcon | string ) : any ;
  }
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ui {
...
declare namespace ?_?.clutz.shaka.ui {
  class Overlay implements ?_?.clutz.shaka.util.IDestroyable {
    ...
    constructor (player : ?_?.clutz.shaka.Player , videoContainer : HTMLElement , video : HTMLMediaElement , vrCanvas ? : HTMLCanvasElement | null ) ;
    ...
    setTextWatermark (text : string , options ? : ?_?.clutz.shaka.ui.Watermark.Options | null ) : any ;
  }
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ui {
  class PlayButton extends ?_?.clutz.shaka.ui.Element implements ?_?.clutz.shaka.extern.IUIPlayButton {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ui {
  class RecenterVRButton extends ?_?.clutz.shaka.ui.Element {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ui {
  class RemoteButton extends ?_?.clutz.shaka.ui.Element {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ui {
  class SaveVideoFrameButton extends ?_?.clutz.shaka.ui.Element {
...
declare namespace ?_?.clutz.shaka.ui {
  class SettingsMenu extends ?_?.clutz.shaka.ui.Element implements ?_?.clutz.shaka.extern.IUISettingsMenu {
    ...
    constructor (parent : HTMLElement , controls : ?_?.clutz.shaka.ui.Controls , iconText : ?_?.clutz.shaka.extern.UIIcon | string ) ;
    backButton : HTMLButtonElement ;
    backSpan : HTMLElement ;
    button : HTMLButtonElement ;
    currentSelection : HTMLElement ;
    icon : ?_?.clutz.shaka.ui.Icon ;
    menu : HTMLElement ;
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ui {
  class SkipNextButton extends ?_?.clutz.shaka.ui.Element {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ui {
  class SkipPreviousButton extends ?_?.clutz.shaka.ui.Element {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ui {
  class ToggleStereoscopicButton extends ?_?.clutz.shaka.ui.Element {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.ui {
  class VideoTypeSelection extends ?_?.clutz.shaka.ui.SettingsMenu {
...
declare namespace ?_?.clutz.shaka.ui {
   ...
   */
  class Watermark extends ?_?.clutz.shaka.ui.Element {
...
declare namespace ?_?.clutz.shaka.util {
  class CmsdManager {
    ...
    constructor (config : ?_?.clutz.shaka.extern.CmsdConfiguration ) ;
    /**
...
declare namespace ?_?.clutz.shaka.util {
  class Mp4Parser {
     ...
     * @param clone True to clone the data into a new buffer, false to create a view on the existing buffer.  Creating a view on the existing buffer will keep the entire buffer in memory so long as the view is reachable.  Use false for temporary values, and true for values that need to outlive the underlying buffer.
     */
    static allData (callback : (a : Uint8Array ) => any , clone : boolean ) : ?_?.clutz.shaka.util.Mp4Parser.CallbackType ;
    /**
     ...
     */
    static audioSampleEntry (box : ?_?.clutz.shaka.extern.ParsedBox ) : any ;
    /**
...
declare namespace ?_?.clutz.shaka.util {
   ...
   */
  class PeriodCombiner implements ?_?.clutz.shaka.util.IReleasable {
    private noStructuralTyping_shaka_util_PeriodCombiner : any;
    combinePeriods (periods : ?_?.clutz.shaka.extern.Period [] , isDynamic : boolean , isPatchUpdate ? : boolean ) : Promise < any > ;
    /**
     * Deletes a stream from matchedStreams because it is no longer needed
     */
    deleteStream (stream : ?_?.clutz.shaka.extern.Stream | null , periodId : string ) : any ;
    getImageStreams ( ) : ?_?.clutz.shaka.extern.Stream [] ;
    getTextStreams ( ) : ?_?.clutz.shaka.extern.Stream [] ;
    getVariants ( ) : ?_?.clutz.shaka.extern.Variant [] ;
    release ( ) : any ;
...
declare namespace ?_?.clutz.shaka.util {
  class StreamUtils {
    ...
    static meetsRestrictions (variant : ?_?.clutz.shaka.extern.Variant , restrictions : ?_?.clutz.shaka.extern.Restrictions , maxHwRes : ?_?.clutz.shaka.extern.Resolution ) : boolean ;
  }
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/dist/shaka-player.ui.debug.externs.js
declare namespace ?_?.clutz.shaka.util {
...
declare namespace ?_?.clutz.shaka.util {
  class TsParser {
     ...
     */
    getAudioData ( ) : ?_?.clutz.shaka.extern.MPEG_PES [] ;
    /**
     ...
     */
    getMetadata ( ) : ?_?.clutz.shaka.extern.ID3Metadata [] ;
    /**
     ...
     */
    getVideoData (naluProcessing ? : boolean ) : ?_?.clutz.shaka.extern.MPEG_PES [] ;
    /**
     ...
     * Return the video data
     */
    getVideoNalus ( ) : ?_?.clutz.shaka.extern.VideoNalu [] ;
    /**
     * Parse the given data
     */
    parse (data : Uint8Array | null ) : ?_?.clutz.shaka.util.TsParser ;
    /**
     ...
     */
    parseNalus (pes : ?_?.clutz.shaka.extern.MPEG_PES , lastInfo : { nalu : ?_?.clutz.shaka.extern.VideoNalu | null , state : number | null } ) : ?_?.clutz.shaka.extern.VideoNalu [] ;
    /**
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/abortable.js
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/abr_manager.js
declare namespace ?_?.clutz.shaka.extern {
  /**
  ...
  interface AbrManager {
     ...
     * Set CMSD manager.
     */
    setCmsdManager (cmsdManager : ?_?.clutz.shaka.util.CmsdManager | null ) : any ;
    /**
     * Set media element.
     */
     ...
     * are equal.
     */
    setVariants (variants : ?_?.clutz.shaka.extern.Variant [] ) : boolean ;
    /**
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/adaptation_set_criteria.js
declare namespace ?_?.clutz.shaka.extern {
  /**
  ...
  interface AdaptationSetCriteria {
     ...
     */
    configure (config : ?_?.clutz.shaka.extern.AdaptationSetCriteria.Configuration ) : any ;
    /**
     * Take a set of variants, and return a subset of variants that can be
     * adapted between.
     */
    create (variants : ?_?.clutz.shaka.extern.Variant [] ) : ?_?.clutz.shaka.media.AdaptationSet ;
    /**
     * Gets the current AdaptationSetCriteria configuration.
     */
    getConfiguration ( ) : ?_?.clutz.shaka.extern.AdaptationSetCriteria.Configuration | null ;
    /**
     * Return the result of last create call.
     */
    getLastAdaptationSet ( ) : ?_?.clutz.shaka.media.AdaptationSet | null ;
  }
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/adaptation_set_criteria.js
declare namespace ?_?.clutz.shaka.extern.AdaptationSetCriteria {
  type Configuration = { activeAudioChannelCount : number , activeAudioCodec : string , audioCodec : string , audioLabel : string , channelCount : number , codecSwitchingStrategy : ?_?.clutz.shaka.config.CodecSwitchingStrategy , hdrLevel : string , language : string , preferredAudioChannelCount : number , preferredAudioCodecs : string [] , role : string , spatialAudio : boolean , videoLabel : string , videoLayout : string , videoRole : string } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/adaptation_set_criteria.js
declare namespace ?_?.clutz.shaka.extern.AdaptationSetCriteria {
  /**
   ...
   */
  type Factory = ( ) => ?_?.clutz.shaka.extern.AdaptationSetCriteria ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/ads.js
declare namespace ?_?.clutz.shaka.extern {
  type AdCuePoint = { end : number | null , start : number } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/ads.js
declare namespace ?_?.clutz.shaka.extern {
  type AdInterstitial = { background : string | null , canJump : boolean , clickThroughUrl : string | null , currentVideo : ?_?.clutz.shaka.extern.AdPositionInfo | null , displayOnBackground : boolean , endTime : number | null , groupId : string | null , id : string | null , isSkippable : boolean , loop : boolean , mimeType : string | null , once : boolean , overlay : ?_?.clutz.shaka.extern.AdPositionInfo | null , playoutLimit : number | null , post : boolean , pre : boolean , resumeOffset : number | null , skipFor : number | null , skipOffset : number | null , startTime : number , timelineRange : boolean , tracking : ?_?.clutz.shaka.extern.AdTrackingEvent | null , uri : string } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/ads.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/ads.js
declare namespace ?_?.clutz.shaka.extern {
  type AdTrackingInfo = { endTime : number | null , position : number , sequenceLength : number , startTime : number , tracking : ?_?.clutz.shaka.extern.AdTrackingEvent | null } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/ads.js
declare namespace ?_?.clutz.shaka.extern {
...
declare namespace ?_?.clutz.shaka.extern {
  ...
  interface IAdManager extends EventTarget {
    ...
    addCustomInterstitial (interstitial : ?_?.clutz.shaka.extern.AdInterstitial ) : any ;
    addMediaTailorTrackingUrl (url : string ) : any ;
    /**
     ...
     */
    configure (config : ?_?.clutz.shaka.extern.AdsConfiguration ) : any ;
    getCuePoints ( ) : ?_?.clutz.shaka.extern.AdCuePoint [] ;
    getCurrentAd ( ) : ?_?.clutz.shaka.extern.IAd | null ;
    getInterstitialPlayer ( ) : ?_?.clutz.shaka.Player | null ;
    /**
     * Get statistics for the current playback session. If the player is not
     * playing content, this will return an empty stats object.
     */
...
declare namespace ?_?.clutz.shaka.extern.IAdManager {
   ...
   */
  type Factory = (a : ?_?.clutz.shaka.Player | null ) => ?_?.clutz.shaka.extern.IAdManager ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/cea.js
declare namespace ?_?.clutz.shaka.extern {
  type CaptionDecoderPlugin = ( ) => ?_?.clutz.shaka.extern.ICaptionDecoder ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/cea.js
declare namespace ?_?.clutz.shaka.extern {
  type CeaParserPlugin = ( ) => ?_?.clutz.shaka.extern.ICeaParser ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/cea.js
declare namespace ?_?.clutz.shaka.extern {
  /**
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/cea.js
declare namespace ?_?.clutz.shaka.extern.ICaptionDecoder {
  /**
   * Parsed Cue.
   */
  type ClosedCaption = { cue : ?_?.clutz.shaka.text.Cue , stream : string } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/cea.js
declare namespace ?_?.clutz.shaka.extern {
  /**
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/cea.js
declare namespace ?_?.clutz.shaka.extern.ICeaParser {
  type CaptionPacket = { packet : Uint8Array , pts : number } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/codecs.js
declare namespace ?_?.clutz.shaka.extern {
  type MPEG_PES = { data : Uint8Array , dts : number | null , nalus : ?_?.clutz.shaka.extern.VideoNalu [] , packetLength : number , pts : number | null } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/codecs.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/manifest.js
declare namespace ?_?.clutz.shaka.extern {
  /**
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/manifest.js
declare namespace ?_?.clutz.shaka.extern {
  type Manifest = { chapterStreams : ?_?.clutz.shaka.extern.Stream [] , gapCount : number , ignoreManifestTimestampsInSegmentsMode : boolean , imageStreams : ?_?.clutz.shaka.extern.Stream [] , isLowLatency : boolean , nextUrl : string | null , offlineSessionIds : string [] , periodCount : number , presentationTimeline : ?_?.clutz.shaka.media.PresentationTimeline , sequenceMode : boolean , serviceDescription : ?_?.clutz.shaka.extern.ServiceDescription | null , startTime : number | null , textStreams : ?_?.clutz.shaka.extern.Stream [] , type : string , variants : ?_?.clutz.shaka.extern.Variant [] } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/manifest.js
declare namespace ?_?.clutz.shaka.extern {
  type Period = { audioStreams : ?_?.clutz.shaka.extern.Stream [] , id : string , imageStreams : ?_?.clutz.shaka.extern.Stream [] , textStreams : ?_?.clutz.shaka.extern.Stream [] , videoStreams : ?_?.clutz.shaka.extern.Stream [] } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/manifest.js
declare namespace ?_?.clutz.shaka.extern {
  /**
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/manifest.js
declare namespace ?_?.clutz.shaka.extern {
  type Stream = { accessibilityPurpose : ?_?.clutz.shaka.media.ManifestParser.AccessibilityPurpose | null , audioSamplingRate : number | null , bandwidth ? : number , baseOriginalId : string | null , channelsCount : number | null , closeSegmentIndex ? : ( ) => any , closedCaptions : Map < string , string > | null , codecs : string , colorGamut ? : string , createSegmentIndex : ?_?.clutz.shaka.extern.CreateSegmentIndexFunction , dependencyStream : any , drmInfos : ?_?.clutz.shaka.extern.DrmInfo [] , emsgSchemeIdUris : string [] | null , encrypted : boolean , external : boolean , fastSwitching : boolean , forced : boolean , frameRate ? : number , fullMimeTypes : Set < string > , groupId : string | null , hdr ? : string , height ? : number , id : number , isAudioMuxedInVideo : boolean , keyIds : Set < string > , kind ? : string , label : string | null , language : string , matchedStreams ? : any [] , mimeType : string , originalId : string | null , originalLanguage : string | null , pixelAspectRatio ? : string , primary : boolean , roles : string [] , segmentIndex : ?_?.clutz.shaka.media.SegmentIndex | null , spatialAudio : boolean , supplementalCodecs : string , tilesLayout ? : string , trickModeVideo : any , type : string , videoLayout ? : string , width ? : number } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/manifest.js
declare namespace ?_?.clutz.shaka.extern {
  type ThumbnailSprite = { height : number , positionX : number , positionY : number , width : number } ;
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/manifest.js
declare namespace ?_?.clutz.shaka.extern {
  type aesKey = { bitsKey : number , blockCipherMode : string , cryptoKey ? : ?_?.clutz.webCrypto.CryptoKey | null , fetchKey ? : ?_?.clutz.shaka.extern.CreateSegmentIndexFunction , firstMediaSequenceNumber : number , iv ? : Uint8Array } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/manifest_parser.js
declare namespace ?_?.clutz.shaka.extern {
  /**
  ...
  interface ManifestParser {
     ...
     */
    onInitialVariantChosen (variant : ?_?.clutz.shaka.extern.Variant ) : any ;
    /**
     * Set media element.
     */
    setMediaElement (mediaElement : HTMLMediaElement | null ) : any ;
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/manifest_parser.js
declare namespace ?_?.clutz.shaka.extern.ManifestParser {
  type PlayerInterface = { addFont : (a : string , b : string ) => any , disableStream : (a : ?_?.clutz.shaka.extern.Stream ) => any , filter : (a : ?_?.clutz.shaka.extern.Manifest ) => Promise < any > , getBandwidthEstimate : ( ) => number , isLowLatencyMode : ( ) => boolean , makeTextStreamsForClosedCaptions : (a : ?_?.clutz.shaka.extern.Manifest ) => any , networkingEngine : ?_?.clutz.shaka.net.NetworkingEngine , newDrmInfo : (a : ?_?.clutz.shaka.extern.Stream ) => any , onError : (a : ?_?.clutz.shaka.util.Error ) => any , onEvent : ?_?.clutz.shaka.util.EventManager.ListenerType , onManifestUpdated : ( ) => any , onMetadata : (a : string , b : number , c : number | null , d : ?_?.clutz.shaka.extern.MetadataFrame [] ) => Promise < any > , onTimelineRegionAdded : (a : ?_?.clutz.shaka.extern.TimelineRegionInfo ) => any , updateDuration : ( ) => any } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/mp4_parser.js
declare namespace ?_?.clutz.shaka.extern {
  type ParsedBox = { flags : number | null , has64BitSize : boolean , name : string , parser : ?_?.clutz.shaka.util.Mp4Parser , partialOkay : boolean , reader : ?_?.clutz.shaka.util.DataViewReader , size : number , start : number , stopOnPartial : boolean , version : number | null } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/net.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/net.js
declare namespace ?_?.clutz.shaka.extern {
  type Request = { allowCrossSiteCredentials : boolean , attempt : number , body : ArrayBuffer | ArrayBufferView | null , contentType ? : string | null , drmInfo : ?_?.clutz.shaka.extern.DrmInfo | null , headers : { [ key: string ]: string } , initData : Uint8Array | null , initDataType : string | null , licenseRequestType : string | null , method : string , packetNumber ? : number | null , requestStartTime ? : number | null , retryParameters : ?_?.clutz.shaka.extern.RetryParameters , sessionId : string | null , streamDataCallback : ( (a : ArrayBuffer | ArrayBufferView ) => Promise < any > ) | null , timeToFirstByte ? : number | null , uris : string [] } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/net.js
declare namespace ?_?.clutz.shaka.extern {
  type RequestContext = { isPreload ? : boolean , segment ? : ?_?.clutz.shaka.media.SegmentReference | null , stream ? : ?_?.clutz.shaka.extern.Stream , type ? : ?_?.clutz.shaka.net.NetworkingEngine.AdvancedRequestType } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/net.js
declare namespace ?_?.clutz.shaka.extern {
  /**
   ...
   */
  type RequestFilter = (a : ?_?.clutz.shaka.net.NetworkingEngine.RequestType , b : ?_?.clutz.shaka.extern.Request , c ? : ?_?.clutz.shaka.extern.RequestContext ) => Promise < any > | void ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/net.js
declare namespace ?_?.clutz.shaka.extern {
  type Response = { data : ArrayBuffer | ArrayBufferView , fromCache ? : boolean , headers : { [ key: string ]: string } , originalRequest : ?_?.clutz.shaka.extern.Request , originalUri : string , status ? : number , timeMs ? : number , uri : string } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/net.js
declare namespace ?_?.clutz.shaka.extern {
  /**
   ...
   */
  type ResponseFilter = (a : ?_?.clutz.shaka.net.NetworkingEngine.RequestType , b : ?_?.clutz.shaka.extern.Response , c ? : ?_?.clutz.shaka.extern.RequestContext ) => Promise < any > | void ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/net.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/net.js
declare namespace ?_?.clutz.shaka.extern {
  type SchemePlugin = (a : string , b : ?_?.clutz.shaka.extern.Request , c : ?_?.clutz.shaka.net.NetworkingEngine.RequestType , d : ?_?.clutz.shaka.extern.ProgressUpdated , e : ?_?.clutz.shaka.extern.HeadersReceived , f : ?_?.clutz.shaka.extern.SchemePluginConfig ) => ?_?.clutz.shaka.extern.IAbortableOperation < ?_?.clutz.shaka.extern.Response > ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/net.js
declare namespace ?_?.clutz.shaka.extern {
  type SchemePluginConfig = { minBytesForProgressEvents ? : number } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/offline.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/offline_compat_v2.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type AudioTrack = { accessibilityPurpose : ?_?.clutz.shaka.media.ManifestParser.AccessibilityPurpose | null , active : boolean , audioSamplingRate : number | null , channelsCount : number | null , codecs : string | null , label : string | null , language : string , mimeType : string | null , originalLanguage : string | null , primary : boolean , roles : string [] , spatialAudio : boolean } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type CmcdConfiguration = { contentId : string , enabled : boolean , includeKeys : string [] , rtpSafetyFactor : number , sessionId : string , targets : ?_?.clutz.shaka.extern.CmcdTarget [] | null , useHeaders : boolean , version : number } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type DashManifestConfiguration = { autoCorrectDrift : boolean , clockSyncUri : string , disableXlinkProcessing : boolean , enableFastSwitching : boolean , ignoreEmptyAdaptationSet : boolean , ignoreMaxSegmentDuration : boolean , ignoreMinBufferTime : boolean , ignoreSuggestedPresentationDelay : boolean , initialSegmentLimit : number , keySystemsByURI : { [ key: string ]: string } , manifestPreprocessorTXml : (a : ?_?.clutz.shaka.extern.xml.Node ) => any , sequenceMode : boolean , useStreamOnceInPeriodFlattening : boolean , xlinkFailGracefully : boolean } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type DrmConfiguration = { advanced : { [ key: string ]: ?_?.clutz.shaka.extern.AdvancedDrmConfiguration } | null , clearKeys : { [ key: string ]: string } , defaultAudioRobustnessForWidevine : string , defaultVideoRobustnessForWidevine : string , delayLicenseRequestUntilPlayed : boolean , ignoreDuplicateInitData : boolean , initDataTransform ? : ?_?.clutz.shaka.extern.InitDataTransform , keySystemsMapping : { [ key: string ]: string } , logLicenseExchange : boolean , minHdcpVersion : string , parseInbandPsshEnabled : boolean , persistentSessionOnlinePlayback : boolean , persistentSessionsMetadata : ?_?.clutz.shaka.extern.PersistentSessionMetadata [] , preferredKeySystems : string [] , retryParameters : ?_?.clutz.shaka.extern.RetryParameters , servers : { [ key: string ]: string } , updateExpirationTime : number } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type EmsgTimelineRegionInfo = { emsg : ?_?.clutz.shaka.extern.EmsgInfo , endTime : number , id : string , schemeIdUri : string , startTime : number } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type HLSMetadata = { endTime : number | null , startTime : number , type : string , values : ?_?.clutz.shaka.extern.MetadataFrame [] } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type InitDataTransform = (a : Uint8Array , b : string , c : ?_?.clutz.shaka.extern.DrmInfo | null ) => Uint8Array ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type LiveSyncConfiguration = { dynamicTargetLatency : ?_?.clutz.shaka.extern.DynamicTargetLatencyConfiguration , enabled : boolean , maxPlaybackRate : number , minPlaybackRate : number , panicMode : boolean , panicThreshold : number , targetLatency : number , targetLatencyTolerance : number } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type ManifestConfiguration = { availabilityWindowOverride : number , continueLoadingWhenPaused : boolean , dash : ?_?.clutz.shaka.extern.DashManifestConfiguration , defaultPresentationDelay : number , disableAudio : boolean , disableChapters : boolean , disableIFrames : boolean , disableText : boolean , disableThumbnails : boolean , disableVideo : boolean , enableAudioGroups : boolean , hls : ?_?.clutz.shaka.extern.HlsManifestConfiguration , ignoreDrmInfo : boolean , ignoreSupplementalCodecs : boolean , raiseFatalErrorOnManifestUpdateRequestFailure : boolean , retryParameters : ?_?.clutz.shaka.extern.RetryParameters , segmentRelativeVttTiming : boolean , updatePeriod : number } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type MediaSourceConfiguration = { addExtraFeaturesToSourceBuffer : (a : string ) => string , codecSwitchingStrategy : ?_?.clutz.shaka.config.CodecSwitchingStrategy , correctEc3Enca : boolean , dispatchAllEmsgBoxes : boolean , durationReductionEmitsUpdateEnd : boolean , forceTransmux : boolean , insertFakeEncryptionInInit : boolean , modifyCueCallback : ?_?.clutz.shaka.extern.TextParser.ModifyCueCallback , useSourceElements : boolean } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type MetadataTimelineRegionInfo = { endTime : number , id : string , payload : ?_?.clutz.shaka.extern.MetadataFrame , schemeIdUri : string , startTime : number } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type PlaybackInfo = { audio : ?_?.clutz.shaka.extern.PlaybackStreamInfo | null , text : ?_?.clutz.shaka.extern.PlaybackStreamInfo | null , video : ?_?.clutz.shaka.extern.PlaybackStreamInfo | null } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type PlayerConfiguration = { abr : ?_?.clutz.shaka.extern.AbrConfiguration , abrFactory : ?_?.clutz.shaka.extern.AbrManager.Factory , adaptationSetCriteriaFactory : ?_?.clutz.shaka.extern.AdaptationSetCriteria.Factory , ads : ?_?.clutz.shaka.extern.AdsConfiguration , autoShowText : ?_?.clutz.shaka.config.AutoShowText , cmcd : ?_?.clutz.shaka.extern.CmcdConfiguration , cmsd : ?_?.clutz.shaka.extern.CmsdConfiguration , drm : ?_?.clutz.shaka.extern.DrmConfiguration , ignoreHardwareResolution : boolean , lcevc : ?_?.clutz.shaka.extern.LcevcConfiguration , manifest : ?_?.clutz.shaka.extern.ManifestConfiguration , mediaSource : ?_?.clutz.shaka.extern.MediaSourceConfiguration , networking : ?_?.clutz.shaka.extern.NetworkingConfiguration , offline : ?_?.clutz.shaka.extern.OfflineConfiguration , playRangeEnd : number , playRangeStart : number , preferForcedSubs : boolean , preferSpatialAudio : boolean , preferredAudioChannelCount : number , preferredAudioCodecs : string [] , preferredAudioLabel : string , preferredAudioLanguage : string , preferredAudioRole : string , preferredDecodingAttributes : string [] , preferredTextFormats : string [] , preferredTextLanguage : string , preferredTextRole : string , preferredVideoCodecs : string [] , preferredVideoHdrLevel : string , preferredVideoLabel : string , preferredVideoLayout : string , preferredVideoRole : string , queue : ?_?.clutz.shaka.extern.QueueConfiguration , restrictions : ?_?.clutz.shaka.extern.Restrictions , streaming : ?_?.clutz.shaka.extern.StreamingConfiguration , textDisplayFactory : ?_?.clutz.shaka.extern.TextDisplayer.Factory , textDisplayer : ?_?.clutz.shaka.extern.TextDisplayerConfiguration } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type QueueConfiguration = { preloadNextUrlWindow : number , preloadPrevItem : boolean , repeatMode : ?_?.clutz.shaka.config.RepeatMode } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type StreamingConfiguration = { allowMediaSourceRecoveries : boolean , avoidEvictionOnQuotaExceededError : boolean , bufferBehind : number , bufferingGoal : number , clearDecodingCache : boolean , crossBoundaryStrategy : ?_?.clutz.shaka.config.CrossBoundaryStrategy , disableAudioPrefetch : boolean , disableTextPrefetch : boolean , disableVideoPrefetch : boolean , dontChooseCodecs : boolean , durationBackoff : number , evictionGoal : number , failureCallback : (a : ?_?.clutz.shaka.util.Error ) => any , gapDetectionThreshold : number , gapJumpTimerTime : number , gapPadding : number , ignoreTextStreamFailures : boolean , inaccurateManifestTolerance : number , liveSync : ?_?.clutz.shaka.extern.LiveSyncConfiguration , loadTimeout : number , lowLatencyMode : boolean , maxDisabledTime : number , minTimeBetweenRecoveries : number , observeQualityChanges : boolean , preferNativeDash : boolean , preferNativeHls : boolean , prefetchAudioLanguages : string [] , preloadNextUrlWindow : number , rebufferingGoal : number , retryParameters : ?_?.clutz.shaka.extern.RetryParameters , returnToEndOfLiveWindowWhenOutside : boolean , safeSeekEndOffset : number , safeSeekOffset : number , segmentPrefetchLimit : number , shouldFixTimestampOffset : boolean , speechToText : ?_?.clutz.shaka.extern.SpeechToTextConfiguration , stallEnabled : boolean , stallSkip : number , stallThreshold : number , startAtSegmentBoundary : boolean , updateIntervalSeconds : number , useNativeHlsForFairPlay : boolean , vodDynamicPlaybackRate : boolean , vodDynamicPlaybackRateBufferRatio : number , vodDynamicPlaybackRateLowBufferRate : number } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type SupportType = { drm : { [ key: string ]: ?_?.clutz.shaka.extern.DrmSupportType | null } , hardwareResolution : ?_?.clutz.shaka.extern.Resolution , manifest : { [ key: string ]: boolean } , media : { [ key: string ]: boolean } } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type TextTrack = { accessibilityPurpose : ?_?.clutz.shaka.media.ManifestParser.AccessibilityPurpose | null , active : boolean , bandwidth : number , codecs : string | null , forced : boolean , id : number , kind : string | null , label : string | null , language : string , mimeType : string | null , originalLanguage : string | null , originalTextId : string | null , primary : boolean , roles : string [] , type : string } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type Thumbnail = { codecs : string | null , duration : number , endByte : number | null , height : number , imageHeight : number , imageWidth : number , mimeType : string | null , positionX : number , positionY : number , segment : ?_?.clutz.shaka.media.SegmentReference | null , sprite : boolean , startByte : number , startTime : number , uris : string [] , width : number } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type TimelineRegionInfo = { endTime : number , eventNode : ?_?.clutz.shaka.extern.xml.Node | null , id : string , schemeIdUri : string , startTime : number , timescale : number , value : string } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
  type Track = { accessibilityPurpose : ?_?.clutz.shaka.media.ManifestParser.AccessibilityPurpose | null , active : boolean , audioBandwidth : number | null , audioCodec : string | null , audioGroupId : string | null , audioId : number | null , audioMimeType : string | null , audioRoles : string [] | null , audioSamplingRate : number | null , bandwidth : number , channelsCount : number | null , codecs : string | null , colorGamut : string | null , forced : boolean , frameRate : number | null , hdr : string | null , height : number | null , id : number , kind : string | null , label : string | null , language : string , mimeType : string | null , originalAudioId : string | null , originalImageId : string | null , originalLanguage : string | null , originalTextId : string | null , originalVideoId : string | null , pixelAspectRatio : string | null , primary : boolean , roles : string [] , spatialAudio : boolean , tilesLayout : string | null , type : string , videoBandwidth : number | null , videoCodec : string | null , videoId : number | null , videoLabel : string | null , videoLayout : string | null , videoMimeType : string | null , videoRoles : string [] | null , width : number | null } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/player.js
declare namespace ?_?.clutz.shaka.extern.xml {
  type Node = { attributes : { [ key: string ]: string } , children : any [] , parent : any , tagName : string } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/queue.js
declare namespace ?_?.clutz.shaka.extern {
  /**
   * An object that's responsible for all the queue-related logic
   * in the player.
   */
  interface IQueueManager extends ?_?.clutz.shaka.util.IDestroyable, EventTarget {
    /**
     * Called by the Player to provide an updated configuration any time it
     * changes.
     */
    configure (config : ?_?.clutz.shaka.extern.QueueConfiguration ) : any ;
    destroy ( ) : Promise < any > ;
    /**
     * Returns the current configuration.
     */
    getConfiguration ( ) : ?_?.clutz.shaka.extern.QueueConfiguration | null ;
    /**
     * Returns the current item.
     */
    getCurrentItem ( ) : ?_?.clutz.shaka.extern.QueueItem | null ;
    /**
     ...
     * Returns all items.
     */
    getItems ( ) : ?_?.clutz.shaka.extern.QueueItem [] ;
    /**
     * Insert new items in the current queue.
     */
    insertItems (items : ?_?.clutz.shaka.extern.QueueItem [] ) : any ;
    /**
     ...
     */
    setCustomPlayer (player : ?_?.clutz.shaka.Player | null ) : any ;
  }
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/queue.js
declare namespace ?_?.clutz.shaka.extern.IQueueManager {
  /**
   * A factory for creating the queue manager.
   */
  type Factory = (a : ?_?.clutz.shaka.Player | null ) => ?_?.clutz.shaka.extern.IQueueManager ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/queue.js
declare namespace ?_?.clutz.shaka.extern {
  type QueueItem = { config : ?_?.clutz.shaka.extern.PlayerConfiguration | null , extraChapter : ?_?.clutz.shaka.extern.ExtraChapter [] | null , extraText : ?_?.clutz.shaka.extern.ExtraText [] | null , extraThumbnail : string [] | null , manifestUri : string , mimeType : string | null , preloadManager : ?_?.clutz.shaka.media.PreloadManager | null , startTime : number | Date | null } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/resolution.js
declare namespace ?_?.clutz.shaka.extern {
  type Resolution = { height : number , width : number } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/text.js
declare namespace ?_?.clutz.shaka.extern {
  interface TextDisplayer extends ?_?.clutz.shaka.util.IDestroyable {
     ...
     */
    configure (config : ?_?.clutz.shaka.extern.TextDisplayerConfiguration ) : any ;
    destroy ( ) : Promise < any > ;
    /**
...
declare namespace ?_?.clutz.shaka.extern {
  ...
  interface TextParser {
     ...
     */
    parseMedia (data : Uint8Array , timeContext : ?_?.clutz.shaka.extern.TextParser.TimeContext , uri : string | undefined | null , images : string [] ) : ?_?.clutz.shaka.text.Cue [] ;
    /**
...
declare namespace ?_?.clutz.shaka.extern.TextParser {
   ...
   */
  type ModifyCueCallback = (a : ?_?.clutz.shaka.text.Cue , b : string | null , c : ?_?.clutz.shaka.extern.TextParser.TimeContext ) => any ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/text.js
declare namespace ?_?.clutz.shaka.extern.TextParser {
  /**
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/transmuxer.js
declare namespace ?_?.clutz.shaka.extern {
  /**
  ...
  interface Transmuxer {
     ...
     */
    transmux (data : ArrayBuffer | ArrayBufferView , stream : ?_?.clutz.shaka.extern.Stream , reference : ?_?.clutz.shaka.media.SegmentReference | null , duration : number , contentType : string ) : Promise < Uint8Array | ?_?.clutz.shaka.extern.TransmuxerOutput > ;
  }
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/externs/shaka/transmuxer.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/ui/externs/ui.js
declare namespace ?_?.clutz.shaka.extern {
  /**
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/ui/externs/ui.js
declare namespace ?_?.clutz.shaka.extern {
  type UIConfiguration = { adStatisticsList : string [] , addBigPlayButton : boolean , addSeekBar : boolean , allowTogglePresentationTime : boolean , alwaysShowVolumeBar : boolean , castAndroidReceiverCompatible : boolean , castReceiverAppId : string , castSenderUrl : string , clearBufferOnQualityChange : boolean , closeMenusDelay : number , contextMenuElements : string [] , controlPanelElements : string [] , customContextMenu : boolean , defaultVrProjectionMode : string , displayInVrMode : boolean , doubleClickForFullscreen : boolean , enableFullscreenOnRotation : boolean , enableKeyboardPlaybackControls : boolean , enableKeyboardPlaybackControlsInWindow : boolean , enableTooltips : boolean , enableVrDeviceMotion : boolean , fadeDelay : number , fastForwardRates : number [] , forceLandscapeOnFullscreen : boolean , fullScreenElement : HTMLElement | null , keyboardLargeSeekDistance : number , keyboardSeekDistance : number , menuOpenUntilUserClosesIt : boolean , overflowMenuButtons : string [] , playbackRates : number [] , preferDocumentPictureInPicture : boolean , preferVideoFullScreenInVisionOS : boolean , qualityMarks : ?_?.clutz.shaka.extern.UIQualityMarks , refreshTickInSeconds : number , rewindRates : number [] , seekBarColors : ?_?.clutz.shaka.extern.UISeekBarColors , seekOnTaps : boolean , setupMediaSession : boolean , shortcuts : ?_?.clutz.shaka.extern.UIShortcuts , showAudioChannelCountVariants : boolean , showAudioCodec : boolean , showRemainingTimeInPresentationTime : boolean , showUnbufferedStart : boolean , showVideoCodec : boolean , singleClickForPlayAndPause : boolean , statisticsList : string [] , tapSeekDistance : number , textTrackLabelFormat : ?_?.clutz.shaka.ui.Overlay.TrackLabelFormat , topControlPanelElements : string [] , trackLabelFormat : ?_?.clutz.shaka.ui.Overlay.TrackLabelFormat , volumeBarColors : ?_?.clutz.shaka.extern.UIVolumeBarColors } ;
}
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/ui/externs/ui.js
declare namespace ?_?.clutz.shaka.extern {
...
// Generated from C:/Users/Hans/Desktop/Code/Shaka-Player/ui/externs/watermark.js
declare namespace ?_?.clutz.shaka.ui.Watermark {

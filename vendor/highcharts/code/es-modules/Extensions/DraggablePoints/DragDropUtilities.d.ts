 ...
 * @template T
 */
declare function addEvents<T>(el: T, types: Array<string>, fn: (Function | EventCallback<T>), options?: U.EventOptions): Function;
/**
 ...
 */
declare function countProps(obj: object): number;
/**
 ...
 * @template T
 */
declare function getFirstProp<T>(obj: Record<string, T>): (T | undefined);
/**
 ...
 */
declare function getNormalizedEvent<T extends PointerEvent>(e: (T | PointerEvent), chart: Chart): PointerEvent;
declare const DragDropUtilities: {
    addEvents: typeof addEvents;
    countProps: typeof countProps;
    getFirstProp: typeof getFirstProp;
    getNormalizedEvent: typeof getNormalizedEvent;
};

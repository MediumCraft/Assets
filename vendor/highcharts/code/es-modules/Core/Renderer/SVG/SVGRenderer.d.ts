...
declare class SVGRenderer implements SVGRendererBase {
    ...
    alignedObjects: Array<SVGElement>;
    allowHTML?: boolean;
    box: globalThis.SVGElement;
    boxWrapper: SVGElement;
    cache: Record<string, BBoxObject>;
    cacheKeys: Array<string>;
    chartIndex: number;
    defs: SVGElement;
    forExport?: boolean;
    globalAnimation: (boolean | Partial<AnimationOptions>);
     ...
     */
    getStyle(style: CSSObject): CSSObject;
    /**
     ...
     */
    getRadialAttr(radialReference: Array<number>, gradAttr: SVGAttributes): SVGAttributes;
    /**
     ...
     */
    shadowDefinition(shadowOptions: Partial<ShadowOptionsObject>): string;
    /**
     ...
     */
    private getShadowFilterContent;
    /**
     ...
     */
    buildText(wrapper: SVGElement): void;
    /**
    ...
    */
    ...
    clipRect(attribs: SVGAttributes): SVGRenderer.ClipRectElement;
     ...
     */
    rotCorr(baseline: number, rotation: number, alterY?: boolean): PositionObject;
    /**
     ...
     */
    pathToSegments(path: (Array<string | number> | SVGPath)): SVGPath;
    /**

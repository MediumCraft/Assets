...
import type { AxisCollectionKey, AxisCrosshairOptions, AxisLabelFormatterCallback, AxisLabelFormatterContextObject, AxisOptions, AxisSetExtremesEventObject, AxisTitleOptions, XAxisOptions, YAxisOptions } from './AxisOptions';
...
declare class Axis {
    ...
    dataMax?: number;
    dataMin?: number;
    eventArgs?: AxisSetExtremesEventObject;
    eventOptions: Record<string, EventCallback<Series, Event>>;
    expectedSpace: number | undefined;
    finalTickAmt?: number;
    forceRedraw?: boolean;

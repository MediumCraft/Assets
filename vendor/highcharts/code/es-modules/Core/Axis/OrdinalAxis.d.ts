...
declare namespace OrdinalAxis {
    class Composition extends Axis {
        ...
        isInternal?: boolean;
        ordinal: Additions;
        getTimeTicks(normalizedInterval: Time.TimeNormalizedObject, min: number, max: number, startOfWeek: number, positions?: Array<number> | Types.TypedArray, closestDistance?: number, findHigherRanks?: boolean): TickPositionsArray;
    ...
    class Additions {
         ...
         * @private
         */
        getExtendedPositions(withOverscroll?: boolean): Array<number>;
        /**
         ...
         */
        getIndexOfPoint(pixelVal: number, ordinalArray: number[]): number;
        /**
         ...
         */
        convertOverscroll(overscroll?: number | string): number;
    }
}

...
declare const Series: typeof SeriesClass;
 ...
 */
declare class ColorAxis extends Axis implements AxisBase {
     ...
     * @private
     */
    constructor(chart: Chart, userOptions: Partial<ColorAxis.Options>);
    added?: boolean;
    chart: Chart;
    coll: "colorAxis";
     ...
     * The color axis options for initialization.
     */
    init(chart: Chart, userOptions: Partial<ColorAxis.Options>): void;
    /**
...
declare namespace ColorAxis {
    type DataClassesOptions = ColorAxisBase.DataClassOptions;
    ...
    interface Options extends ColorAxisBase.Options {

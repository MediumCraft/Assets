...
declare class Tick {
     ...
     */
    createLabel(str: string, labelOptions: AxisLabelOptions, xy?: PositionObject): (SVGElement | undefined);
    /**
     ...
     * @private
     */
    getMarkPath(x: number, y: number, tickLength: number, tickWidth: number, horiz: boolean | undefined, renderer: SVGRenderer): SVGPath;
    /**
     ...
     */
    renderGridLine(old: boolean | undefined, opacity: number): void;
    /**
     ...
     */
    renderMark(xy: PositionObject, opacity: number): void;
    /**

...
declare class Series {
     ...
     * preserved
     */
    static keepPropsForPoints: string[];
     ...
     */
    hasMarkerChanged(options: DeepPartial<SeriesOptions>, oldOptions: DeepPartial<SeriesOptions>): boolean | undefined;
    /**
     ...
     *        `false` to prevent.
     */
    setData(data: Array<(PointOptions | PointShortOptions)> | undefined, redraw?: boolean, animation?: (boolean | Partial<AnimationOptions>), updatePoints?: boolean): void;
    /**
     ...
     */
    cropData(table: DataTableCore, min: number, max: number): Series.CropDataObject;
    /**
     ...
     * Force getting extremes of a total series data range.
     */
    getExtremes(yData?: (Array<(number | null)> | Array<Array<(number | null)>> | Types.TypedArray), forceExtremesFromAll?: boolean): DataExtremesObject;
    /**
     ...
     */
    getFirstValidPoint(data: Array<(PointOptions | PointShortOptions)>, start?: number, increment?: number): (PointOptions | PointShortOptions | undefined);
    /**
     ...
     */
    plotGroup(prop: 'group' | 'markerGroup' | 'dataLabelsGroup', name: string, visibility: 'hidden' | 'inherit' | 'visible', zIndex?: number, parent?: SVGElement): SVGElement;
    /**

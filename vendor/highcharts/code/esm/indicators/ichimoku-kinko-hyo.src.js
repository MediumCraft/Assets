...
const { parse: IKHIndicator_color } = (external_highcharts_src_js_default_Color_default());

const { sma: SMAIndicator } = (external_highcharts_src_js_default_SeriesRegistry_default()).seriesTypes;

const { defined: IKHIndicator_defined, extend: IKHIndicator_extend, isArray: IKHIndicator_isArray, isNumber: IKHIndicator_isNumber, getClosestDistance, merge: IKHIndicator_merge, objectEach: IKHIndicator_objectEach } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Functions
 *
...
class IKHIndicator extends SMAIndicator {
    ...
    init() {
        ...
        this.options = IKHIndicator_merge({
            ...
            senkouSpanA: {
                styles: {
                    lineColor: this.color,
                    fill: IKHIndicator_color(this.color).setOpacity(0.5).get()
                }
            },
            senkouSpanB: {
                styles: {
            ...
            senkouSpan: {
                styles: {
                    fill: IKHIndicator_color(this.color).setOpacity(0.2).get()
                }
            }
        }, this.options);
    }
    ...
    drawGraph() {
        ...
        IKHIndicator_objectEach(ikhMap, (values, lineName) => {
 ...
 */
IKHIndicator.defaultOptions = IKHIndicator_merge(SMAIndicator.defaultOptions, {
    /**
     * @excluding index
     */
    params: {

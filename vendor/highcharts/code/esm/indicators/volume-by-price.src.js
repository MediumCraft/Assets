...
const { column: { prototype: VBPIndicator_columnProto }, sma: SMAIndicator } = (external_highcharts_src_js_default_SeriesRegistry_default()).seriesTypes;

const { addEvent: VBPIndicator_addEvent, arrayMax: VBPIndicator_arrayMax, arrayMin: VBPIndicator_arrayMin, correctFloat: VBPIndicator_correctFloat, defined: VBPIndicator_defined, error: VBPIndicator_error, extend: VBPIndicator_extend, isArray: VBPIndicator_isArray, merge: VBPIndicator_merge } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Constants
 *
...
class VBPIndicator extends SMAIndicator {
    ...
    translate() {
        ...
        if (indicatorPoints.length) {
            ...
            maxVolume = VBPIndicator_arrayMax(volumeDataArray);
    ...
    specifyZones(isOHLC, xValues, yValues, ranges, volumeSeries) {
        ...
        let lowRange = rangeExtremes ?
            rangeExtremes.min :
            VBPIndicator_arrayMin(yValues), highRange = rangeExtremes ?
            rangeExtremes.max :
            VBPIndicator_arrayMax(yValues), i = 0, j = 1;
 ...
 */
VBPIndicator.defaultOptions = VBPIndicator_merge(SMAIndicator.defaultOptions, {
    /**

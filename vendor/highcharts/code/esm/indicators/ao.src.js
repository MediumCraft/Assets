...
const { noop: AOIndicator_noop } = (external_highcharts_src_js_default_default());

const { column: { prototype: AOIndicator_columnProto }, sma: SMAIndicator } = (external_highcharts_src_js_default_SeriesRegistry_default()).seriesTypes;
 ...
 */
AOIndicator.defaultOptions = AOIndicator_merge(SMAIndicator.defaultOptions, {
    params: {
...
AOIndicator_extend(AOIndicator.prototype, {
    ...
    // Columns support:
    markerAttribs: AOIndicator_noop,
    getColumnMetrics: AOIndicator_columnProto.getColumnMetrics,
    crispCol: AOIndicator_columnProto.crispCol,
    translate: AOIndicator_columnProto.translate,
    drawPoints: AOIndicator_columnProto.drawPoints
});

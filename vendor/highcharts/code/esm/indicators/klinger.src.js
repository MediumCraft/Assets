/**
 * @license Highcharts Stock JS v12.4.0-modified (2025-11-15)
...
const { defined: MultipleLinesComposition_defined, error: MultipleLinesComposition_error, merge: MultipleLinesComposition_merge } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Composition
 *
        ...
        secondaryLinesNames.forEach((plotLine, index) => {
            ...
            while (pointsLength--) {
                ...
                secondaryLines[index].push({
                    ...
                    isNull: !MultipleLinesComposition_defined(point[plotLine])
                });
            }

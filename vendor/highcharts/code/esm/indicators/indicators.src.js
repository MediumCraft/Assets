...
const { addEvent: DataModifyComposition_addEvent, arrayMax, arrayMin, correctFloat: DataModifyComposition_correctFloat, defined: DataModifyComposition_defined, isArray: DataModifyComposition_isArray, isNumber, isString, pick: DataModifyComposition_pick } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Composition
 *
...
const indicators_src_G = (external_highcharts_src_js_default_default());
indicators_src_G.MultipleLinesComposition =
    indicators_src_G.MultipleLinesComposition || Indicators_MultipleLinesComposition;

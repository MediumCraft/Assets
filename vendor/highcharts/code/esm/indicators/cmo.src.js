...
const { isNumber: CMOIndicator_isNumber, merge: CMOIndicator_merge } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Class
 *
...
class CMOIndicator extends SMAIndicator {
    ...
    getValues(series, params) {
        ...
        if (CMOIndicator_isNumber(yVal[0])) {
            values = yVal;
        }
        else {
 ...
 */
CMOIndicator.defaultOptions = CMOIndicator_merge(SMAIndicator.defaultOptions, {
    params: {
        period: 20,
        index: 3
    }

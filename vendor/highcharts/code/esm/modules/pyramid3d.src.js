...
CylinderSeries.defaultOptions = CylinderSeries_merge(ColumnSeries.defaultOptions, Cylinder_CylinderSeriesDefaults);
...
const { charts: SVGElement3DFunnel_charts } = (external_highcharts_src_js_default_default());

const { Element3D: SVGElement3DFunnel_SVGElement3D } = external_highcharts_src_js_default_RendererRegistry_default().getRendererType().prototype;

const { merge: SVGElement3DFunnel_merge } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Class
 *
 * */
class SVGElement3DFunnel extends SVGElement3DFunnel_SVGElement3D {
    constructor() {
        /* *
         *
         *  Properties
    ...
    opacitySetter(value) {
        const funnel3d = this, opacity = parseFloat(value), parts = funnel3d.parts, chart = SVGElement3DFunnel_charts[funnel3d.renderer.chartIndex], filterId = 'group-opacity-' + opacity + '-' + chart.index;
    ...
    fillSetter(fill) {
        ...
        if (fillColor.linearGradient) {
            ...
            for (const sideGroupName of funnel3d.sideGroups) {
                const box = funnel3d[sideGroupName].gradientBox, gradient = fillColor.linearGradient, alteredGradient = SVGElement3DFunnel_merge(fillColor, {
                    linearGradient: {
            ...
            SVGElement3DFunnel_merge(true, partsWithColor, {
...
const { error, extend: Funnel3DComposition_extend, merge: Funnel3DComposition_merge } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Functions
 *
 * */
/** @private */
function Funnel3DComposition_compose(SVGRendererClass) {
    const rendererProto = SVGRendererClass.prototype;
    if (!rendererProto.funnel3d) {
        rendererProto.Element3D.types.funnel3d = Funnel3D_SVGElement3DFunnel;
        Funnel3DComposition_extend(rendererProto, {
...
const Funnel3DComposition = {
    compose: Funnel3DComposition_compose
};
...
const { seriesTypes: { column: Funnel3DPoint_ColumnSeries } } = (external_highcharts_src_js_default_SeriesRegistry_default());
 ...
 *
 * */
class Funnel3DPoint extends Funnel3DPoint_ColumnSeries.prototype.pointClass {
}
...
/* harmony default export */ const funnel3d_src = ((/* unused pure expression or super */ null && (Highcharts)));
...
const { funnel3d: Pyramid3DSeries_Funnel3DSeries } = (external_highcharts_src_js_default_SeriesRegistry_default()).seriesTypes;

const { merge: Pyramid3DSeries_merge } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Class
 *
 ...
 * @requires modules/pyramid3d
 */
class Pyramid3DSeries extends Pyramid3DSeries_Funnel3DSeries {
}
/* *
 *
 *  Static Properties
 *
 * */
Pyramid3DSeries.defaultOptions = Pyramid3DSeries_merge(Pyramid3DSeries_Funnel3DSeries.defaultOptions, Pyramid3D_Pyramid3DSeriesDefaults);

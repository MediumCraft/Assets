...
const { column: { prototype: { pointClass: RenkoPoint_ColumnPoint } } } = (external_highcharts_src_js_default_SeriesRegistry_default()).seriesTypes;
/* *
 *
 *  Class
 *
 * */
class RenkoPoint extends RenkoPoint_ColumnPoint {
    getClassName() {
        return (super.getClassName.call(this) +
...
const { extend: RenkoSeries_extend, merge: RenkoSeries_merge, relativeLength, isNumber: RenkoSeries_isNumber } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Class
 *
 ...
 *
 * */
RenkoSeries.defaultOptions = RenkoSeries_merge((external_highcharts_src_js_default_Series_types_column_default()).defaultOptions, RenkoSeriesDefaults);

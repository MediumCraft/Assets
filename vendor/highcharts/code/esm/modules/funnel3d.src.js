...
const { parse: Chart3D_color } = (external_highcharts_src_js_default_Color_default());
...
const { addEvent, isArray, merge: Chart3D_merge, pick: Chart3D_pick, wrap } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Composition
 *
...
(function (Chart3D) {
    ...
    function compose(ChartClass, FxClass) {
        ...
        Chart3D_merge(true, genericDefaultOptions, Chart3D.defaultOptions);
    ...
    function onAfterDrawChartBox() {
        if (this.chart3d &&
            ...
            chart.frameShapes.bottom[verb]({
                ...
                faces: [{
                        fill: Chart3D_color(frame.bottom.color).brighten(0.1).get(),
                        vertexes: [{
                                x: xmm,
                                y: ypp,
                                z: zmm
                    ...
                    {
                        fill: Chart3D_color(frame.bottom.color).get(),
                        vertexes: [{
                                x: xpp,
                                y: ypp,
                                z: zmm
            ...
            chart.frameShapes.top[verb]({
                ...
                faces: [{
                        fill: Chart3D_color(frame.top.color).brighten(0.1).get(),
                        vertexes: [{
                                x: xmm,
                                y: ymm,
                                z: zpp
                    ...
                    {
                        fill: Chart3D_color(frame.top.color).get(),
                        vertexes: [{
                                x: xmm,
                                y: ymm,
                                z: zmm
            ...
            chart.frameShapes.left[verb]({
                ...
                faces: [{
                        fill: Chart3D_color(frame.left.color).brighten(0.1).get(),
                        vertexes: [{
                                x: xmm,
                                y: ypp,
                                z: zmm
                    ...
                    {
                        fill: Chart3D_color(frame.left.color).get(),
                        vertexes: [{
                                x: xmm,
                                y: ypp,
                                z: zmm
            ...
            chart.frameShapes.right[verb]({
                ...
                faces: [{
                        fill: Chart3D_color(frame.right.color).brighten(0.1).get(),
                        vertexes: [{
                                x: xpp,
                                y: ypp,
                                z: zpp
                    ...
                    {
                        fill: Chart3D_color(frame.right.color).get(),
                        vertexes: [{
                                x: xpp,
                                y: ymm,
                                z: zmm
            ...
            chart.frameShapes.back[verb]({
                ...
                faces: [{
                        fill: Chart3D_color(frame.back.color).brighten(0.1).get(),
                        vertexes: [{
                                x: xpp,
                                y: ypp,
                                z: zpp
                    ...
                    {
                        fill: Chart3D_color(frame.back.color).get(),
                        vertexes: [{
                                x: xm,
                                y: ym,
                                z: zp
            ...
            chart.frameShapes.front[verb]({
                ...
                faces: [{
                        fill: Chart3D_color(frame.front.color).brighten(0.1).get(),
                        vertexes: [{
                                x: xmm,
                                y: ypp,
                                z: zmm
                    ...
                    {
                        fill: Chart3D_color(frame.front.color).get(),
                        vertexes: [{
                                x: xp,
                                y: ym,
                                z: zm
 ...
 *
 */
function Area3DSeries_compose(AreaSeriesClass) {
...
const { addEvent: Tick3DComposition_addEvent, extend: Tick3DComposition_extend, pushUnique: Tick3DComposition_pushUnique, wrap: Tick3DComposition_wrap } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Functions
 *
...
function onTickAfterGetLabelPosition(e) {
    ...
    if (axis3D) {
        Tick3DComposition_extend(e.pos, axis3D.fix3dPosition(e.pos));
    }
}
/**
 * @private
 ...
 *
 * */
class SVGElement3D_SVGElement3D extends SVGElement {
    constructor() {
        /* *
         *
         *  Static Properties
...
SVGElement3D_SVGElement3D.types = {
    base: SVGElement3D_SVGElement3D,
    cuboid: SVGElement3D_SVGElement3D
};
/* *
 *
 *  Default Export
 *
 * */
/* harmony default export */ const SVG_SVGElement3D = (SVGElement3D_SVGElement3D);
...
const { charts: SVGRenderer3D_charts, deg2rad: SVGRenderer3D_deg2rad } = (external_highcharts_src_js_default_default());
...
(function (SVGRenderer3D) {
    ...
    function face3d(args) {
        ...
        ret.attr = function (hash) {
            if (typeof hash === 'object' &&
                ...
                const chart = SVGRenderer3D_charts[renderer.chartIndex], vertexes2d = SVGRenderer3D_perspective(this.vertexes, chart, this.insidePlotArea), path = renderer.toLinePath(vertexes2d, true), area = SVGRenderer3D_shapeArea(vertexes2d);
                hash.d = path;
        ...
        ret.animate = function (params) {
            if (typeof params === 'object' &&
                ...
                const chart = SVGRenderer3D_charts[renderer.chartIndex], vertexes2d = SVGRenderer3D_perspective(this.vertexes, chart, this.insidePlotArea), path = renderer.toLinePath(vertexes2d, true), area = SVGRenderer3D_shapeArea(vertexes2d), visibility = (this.enabled && area > 0) ?
                    'visible' : 'hidden';
                params.d = path;
    ...
    function cuboidPath(shapeArgs) {
        ...
        // to be at least 1px
        h = shapeArgs.height || 0, w = shapeArgs.width || 0, d = shapeArgs.depth || 0, chart = SVGRenderer3D_charts[this.chartIndex], options3d = chart.options.chart.options3d, alpha = options3d.alpha, 
...
const external_highcharts_src_js_default_Series_types_scatter_namespaceObject = __WEBPACK_EXTERNAL_MODULE__highcharts_src_js_8202131d__["default"].Series.types.scatter;
...
/* harmony default export */ const highcharts_3d_src = ((/* unused pure expression or super */ null && (G)));
...
const { Element3D: SVGElement3DCylinder_SVGElement3D } = external_highcharts_src_js_default_RendererRegistry_default().getRendererType().prototype;
/* *
 *
 *  Class
 *
 * */
class SVGElement3DCylinder extends SVGElement3DCylinder_SVGElement3D {
    constructor() {
        /* *
         *
         *  Properties
...
const { charts: CylinderComposition_charts, deg2rad: CylinderComposition_deg2rad } = (external_highcharts_src_js_default_default());

const { perspective: CylinderComposition_perspective } = Core_Math3D;


const { extend: CylinderComposition_extend, pick: CylinderComposition_pick } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Functions
 *
 ...
 *
 */
function CylinderComposition_compose(SVGRendererClass) {
    const rendererProto = SVGRendererClass.prototype;
    if (!rendererProto.cylinder) {
        rendererProto.Element3D.types.cylinder = Cylinder_SVGElement3DCylinder;
        CylinderComposition_extend(rendererProto, {
...
function rendererCylinderPath(shapeArgs) {
    const renderer = this, chart = CylinderComposition_charts[renderer.chartIndex], 
...
const CylinderComposition = {
    compose: CylinderComposition_compose
};
...
const { column: CylinderSeries_ColumnSeries } = (external_highcharts_src_js_default_SeriesRegistry_default()).seriesTypes;

const { extend: CylinderSeries_extend, merge: CylinderSeries_merge } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Class
 *
 ...
 * @augments Highcharts.Series
 */
class CylinderSeries extends CylinderSeries_ColumnSeries {
}
/* *
 *
 *  Static Properties
...
CylinderSeries.defaultOptions = CylinderSeries_merge(CylinderSeries_ColumnSeries.defaultOptions, Cylinder_CylinderSeriesDefaults);
...
/* harmony default export */ const cylinder_src = ((/* unused pure expression or super */ null && (Highcharts)));

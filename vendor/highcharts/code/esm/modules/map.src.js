...
const { addEvent: MapNavigation_addEvent, extend: MapNavigation_extend, merge: MapNavigation_merge, objectEach, pick: MapNavigation_pick, pushUnique } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Functions
 *
...
const { series: BubbleSeries_Series, seriesTypes: { column: { prototype: BubbleSeries_columnProto }, scatter: BubbleSeries_ScatterSeries } } = (external_highcharts_src_js_default_SeriesRegistry_default());

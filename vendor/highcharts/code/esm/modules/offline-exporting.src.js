...
const { addEvent: Fullscreen_addEvent, fireEvent, pushUnique: Fullscreen_pushUnique } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Functions
 *
...
const { addEvent: Exporting_addEvent, clearTimeout: Exporting_clearTimeout, createElement, css, discardElement, error: Exporting_error, extend: Exporting_extend, find, fireEvent: Exporting_fireEvent, isObject, merge, objectEach, pick, pushUnique: Exporting_pushUnique, removeEvent, splat, uniqueKey } = (external_highcharts_src_js_default_default());
...
const offline_exporting_src_G = (external_highcharts_src_js_default_default());
// Compatibility
offline_exporting_src_G.dataURLtoBlob = offline_exporting_src_G.dataURLtoBlob || Shared_DownloadURL.dataURLtoBlob;
offline_exporting_src_G.downloadSVGLocal = OfflineExporting_OfflineExporting.downloadSVGLocal;
offline_exporting_src_G.downloadURL = offline_exporting_src_G.downloadURL || Shared_DownloadURL.downloadURL;
// Compose
OfflineExporting_OfflineExporting.compose(offline_exporting_src_G.Exporting);

...
const { seriesTypes: { candlestick: HollowCandlestickPoint_CandlestickSeries } } = (external_highcharts_src_js_default_SeriesRegistry_default());
/* *
 *
 *  Class
 *
 * */
class HollowCandlestickPoint extends HollowCandlestickPoint_CandlestickSeries.prototype.pointClass {
    /* *
     *
     *  Functions
     *
...
const { addEvent: HollowCandlestickSeries_addEvent, merge: HollowCandlestickSeries_merge } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Code
 *
 ...
 */
HollowCandlestickSeries.defaultOptions = HollowCandlestickSeries_merge(HollowCandlestickSeries_CandlestickSeries.defaultOptions, {
    /**
...
HollowCandlestickSeries_addEvent(HollowCandlestickSeries, 'updatedData', function () {
...
HollowCandlestickSeries_addEvent((external_highcharts_src_js_default_Axis_default()), 'postProcessData', function () {
    const axis = this, series = axis.series;
    series.forEach(function (series) {

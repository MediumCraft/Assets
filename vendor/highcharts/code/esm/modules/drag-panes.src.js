...
const { addEvent: DataModifyComposition_addEvent, arrayMax, arrayMin, correctFloat, defined, isArray, isNumber: DataModifyComposition_isNumber, isString, pick } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Composition
 *
...
const { addEvent: StockChart_addEvent, clamp: StockChart_clamp, crisp, defined: StockChart_defined, extend, find, isNumber: StockChart_isNumber, isString: StockChart_isString, merge: StockChart_merge, pick: StockChart_pick, splat } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Functions
 *
...
const { addEvent: FlagsSeries_addEvent, defined: FlagsSeries_defined, extend: FlagsSeries_extend, isNumber: FlagsSeries_isNumber, merge: FlagsSeries_merge, objectEach: FlagsSeries_objectEach, wrap: FlagsSeries_wrap } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Classes
 *
...
const drag_panes_src_G = (external_highcharts_src_js_default_default());
drag_panes_src_G.AxisResizer = DragPanes_AxisResizer;
DragPanes_DragPanes.compose(drag_panes_src_G.Axis, drag_panes_src_G.Pointer);

...
const { sankey: { prototype: { pointClass: DependencyWheelPoint_SankeyPoint } } } = (external_highcharts_src_js_default_SeriesRegistry_default()).seriesTypes;
 ...
 *
 * */
class DependencyWheelPoint extends DependencyWheelPoint_SankeyPoint {
    /* *
     *
     *  Functions
     *
...
const { pie: PieSeries, sankey: DependencyWheelSeries_SankeySeries } = (external_highcharts_src_js_default_SeriesRegistry_default()).seriesTypes;
 ...
 */
class DependencyWheelSeries extends DependencyWheelSeries_SankeySeries {
    /* *
     *
     *  Functions
     *
 ...
 *
 * */
DependencyWheelSeries.defaultOptions = DependencyWheelSeries_merge(DependencyWheelSeries_SankeySeries.defaultOptions, DependencyWheel_DependencyWheelSeriesDefaults);

...
const { scatter: ScatterSeries, column: { prototype: PointAndFigureSeries_columnProto } } = (external_highcharts_src_js_default_SeriesRegistry_default()).seriesTypes;
const { extend: PointAndFigureSeries_extend, merge: PointAndFigureSeries_merge, pushUnique: PointAndFigureSeries_pushUnique, isNumber: PointAndFigureSeries_isNumber, relativeLength } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Declarations
 *
...
class PointAndFigureSeries extends ScatterSeries {
    ...
    static compose(SVGRendererClass) {
        if (PointAndFigureSeries_pushUnique(PointAndFigureSeries_composed, 'pointandfigure')) {
    ...
    getProcessedData() {
        ...
        const series = this, modified = this.dataTable.getModified(), options = series.options, xData = series.getColumn('x', true), yData = series.getColumn('y', true), boxSize = options.boxSize, calculatedBoxSize = PointAndFigureSeries_isNumber(boxSize) ?
...
PointAndFigureSeries.defaultOptions = PointAndFigureSeries_merge(ScatterSeries.defaultOptions, PointAndFigure_PointAndFigureSeriesDefaults);
PointAndFigureSeries_extend(PointAndFigureSeries.prototype, {
    takeOrdinalPosition: true,
    pnfDataGroups: [],
    getColumnMetrics: PointAndFigureSeries_columnProto.getColumnMetrics,
...
const pointandfigure_src_G = (external_highcharts_src_js_default_default());
PointAndFigure_PointAndFigureSeries.compose(pointandfigure_src_G.Renderer);

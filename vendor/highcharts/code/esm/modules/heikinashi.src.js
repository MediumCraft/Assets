...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
pointClass: HeikinAshiPoint_HLCPoint } } } = (external_highcharts_src_js_default_SeriesRegistry_default()).seriesTypes;
/* *
 *
 *  Class
 *
...
const { composed: HeikinAshiSeries_composed } = (external_highcharts_src_js_default_default());



const { candlestick: HeikinAshiSeries_CandlestickSeries } = (external_highcharts_src_js_default_SeriesRegistry_default()).seriesTypes;

const { addEvent: HeikinAshiSeries_addEvent, merge: HeikinAshiSeries_merge, pushUnique: HeikinAshiSeries_pushUnique } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Functions
 *
 ...
 * @augments Highcharts.Series
 */
class HeikinAshiSeries extends HeikinAshiSeries_CandlestickSeries {
    constructor() {
        /* *
         *
         *  Static Properties
    ...
    static compose(SeriesClass, AxisClass) {
        HeikinAshiSeries_CandlestickSeries.compose(SeriesClass);
        if (HeikinAshiSeries_pushUnique(HeikinAshiSeries_composed, 'HeikinAshi')) {
            HeikinAshiSeries_addEvent(AxisClass, 'postProcessData', onAxisPostProcessData);
            HeikinAshiSeries_addEvent(HeikinAshiSeries, 'afterTranslate', onHeikinAshiSeriesAfterTranslate);
            HeikinAshiSeries_addEvent(HeikinAshiSeries, 'updatedData', onHeikinAshiSeriesUpdatedData);
        }
    }
    /* *
     *
...
HeikinAshiSeries.defaultOptions = HeikinAshiSeries_merge(HeikinAshiSeries_CandlestickSeries.defaultOptions, HeikinAshiSeriesDefaults);
/* *
 *
 *  Class Prototype
 *
...
const heikinashi_src_G = (external_highcharts_src_js_default_default());
HeikinAshi_HeikinAshiSeries.compose(heikinashi_src_G.Series, heikinashi_src_G.Axis);

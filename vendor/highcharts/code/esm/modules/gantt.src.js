...
const { correctFloat: XRangeSeriesDefaults_correctFloat, isNumber: XRangeSeriesDefaults_isNumber, isObject } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Constants
 *
...
const { extend: XRangePoint_extend } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Class
 *
...
const { composed: XRangeSeries_composed, noop } = (external_highcharts_src_js_default_default());

const { parse: XRangeSeries_color } = (external_highcharts_src_js_default_Color_default());

const { column: ColumnSeries } = (external_highcharts_src_js_default_SeriesRegistry_default()).seriesTypes;

const { addEvent: XRangeSeries_addEvent, clamp: XRangeSeries_clamp, crisp: XRangeSeries_crisp, defined: XRangeSeries_defined, extend: XRangeSeries_extend, find: XRangeSeries_find, isNumber: XRangeSeries_isNumber, isObject: XRangeSeries_isObject, merge: XRangeSeries_merge, pick: XRangeSeries_pick, pushUnique: XRangeSeries_pushUnique, relativeLength: XRangeSeries_relativeLength } = (external_highcharts_src_js_default_default());
...
const { xrange: { prototype: { pointClass: GanttPoint_XRangePoint } } } = (external_highcharts_src_js_default_SeriesRegistry_default()).seriesTypes;
/* *
 *
 *  Class
 *
...
const { series: Series, seriesTypes: { xrange: GanttSeries_XRangeSeries } } = (external_highcharts_src_js_default_SeriesRegistry_default());

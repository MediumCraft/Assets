...
var DataTable = /** @class */ (function (_super) {
    ...
    DataTable.prototype.deleteRows = function (rowIndex, rowCount, eventDetail) {
        ...
        if (rowCount > 0 && rowIndex < table.rowCount) {
            var columns = table.columns, columnIds = Object.keys(columns);
            for (var i = 0, iEnd = columnIds.length, column = void 0, deletedCells = void 0, columnId = void 0; i < iEnd; ++i) {
                columnId = columnIds[i];
                column = columns[columnId];
                var result = splice(column, rowIndex, rowCount);

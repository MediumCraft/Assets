 ...
 *
 * Copyright MediumCraft Development
 *
 * All rights reserved. Do not redistribute unless explicitly stated.
 *
...
function requestAccessToLocalFile(fileUrl, overlayManager, callback) {
  ...
  chromeFileAccessOverlayPromise.then(function () {
    ...
    const i18nFileAccessLabel = chrome_i18n_allow_access_to_file_urls_namespaceObject[chrome.i18n.getUILanguage?.()];

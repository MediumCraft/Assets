...
declare class Features {
    ...
    importGeoJson(geoJson: GeoJsonImportFeatureCollection | GeoJsonImportFeature, idPropertyName?: string): {
        stats: {
            total: number;
            success: number;
            failed: number;
    ...
    asGeoJsonFeatureCollection({ shapeTypes, sourceNames, idPropertyName, }: {
